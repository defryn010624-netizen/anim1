...
<head>
    ...
    <style>
        ...
        @keyframes float {
            ...
            25% {
                transform: translate3d(-5px, -5px, 0) scale3d(1.02, 1.02, 1);
            }
            50% {
                transform: translate3d(5px, 5px, 0) scale3d(0.98, 0.98, 1);
            }
            75% {
                transform: translate3d(-3px, 3px, 0) scale3d(1.01, 1.01, 1);
            }
        }
